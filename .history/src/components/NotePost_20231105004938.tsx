...
export default function NotePost() {
  return (
    <div className='py-8 border-t border-gray-300'>
      <h2 className='text-xl  font-bold text-black/80'>블로그 시작하기</h2>
      ...
      <div className='flex justify-between items-center mt-2'>
        <div className='flex items-center gap-2'>
          <span className='cursor-pointer py-1 px-2 bg-slate-100 rounded text-slate-500 select-none font-medium'>
            {/* 댓글 달기 */}
            댓글 <span className='font-semibold'>19</span>개 보기
          </span>
          <span className='font-medium text-black/50'>
            공감 <span className='font-semibold text-black/70'>287</span>
          </span>
        </div>
