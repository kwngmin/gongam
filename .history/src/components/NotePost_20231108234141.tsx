  ...
  return (
    <article className='py-8 border-t border-gray-300'>
      ...
      <form action='' className='py-2'>
        <div className='flex items-center p-1 border-0 outline-0 bg-slate-50 rounded-2xl gap-1'>
          <input
            className='grow rounded py-2 px-4 focus:border-none focus:outline-none bg-slate-300'
            type='text'
