...
export default function InputText({ openInput }: Props) {
  ...
  return (
    <form action='' className='py-2'>
      <div className='flex items-center py-1 px-2 ring-1 ring-slate-300 bg-slate-50 rounded-2xl gap-2 focus-within:ring focus-within:ring-slate-500'>
        <input
        ...
        <button className='w-7 h-7 flex justify-center items-center rounded-full text-sm font-medium bg-gray-700'>
          <RoundIcon name='arrow_right_alt' filled style='text-white medium' />
        </button>
      </div>
    </form>
  );
