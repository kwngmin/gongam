...
import SmallButton from './SmallTextIconButton';
import Seperator from './ui/Seperator';
import SmallTextbutton from './ui/SmallTextbutton';
    ...
    <article className='py-8 border-t border-gray-300'>
      ...
      <div className='flex justify-between items-center my-3'>
        <div className='flex items-center gap-4'>
          ...
          {/* <Seperator /> */}
          <span className='bg-slate-100 px-2 h-8 flex items-center font-medium rounded text-slate-600 text-sm'>
            구독하기
          </span>
        </div>
        <div className='flex items-center gap-4'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2 my-2 items-center'>
          ...
          <SmallTextbutton func={() => {}} text='전체 보기' />
          <Seperator />

          {!openInput ? (
            <SmallTextbutton func={() => setOpenInput(true)} text='댓글 쓰기' />
          ) : (
            <SmallTextbutton
