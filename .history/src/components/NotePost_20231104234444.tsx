      ...
      <div className='text-black/80 mt-2 break-keep'>
        ...
        <div>
          <div className='flex items-center'>
            <RoundIcon filled name='bookmark' style='opacity-20' />
            <RoundIcon filled name='favorite' style='opacity-20' />
            <div className='w-6 h-6 flex justify-center items-center pb-[2px]  style='opacity-20' '>
              <BsFillChatFill size='19px' />
            </div>
