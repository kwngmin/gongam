  ...
  return (
    <div className='py-8 border-t border-gray-300'>
      ...
      <div className='flex flex-col gap-1'>
        <div>사이드 프로젝트로 하고 있는 reflow 반응이 점점 좋아지고 있다.</div>
        <div>생각보다 많은 레포트수와 100% 리텐션이 강렬하지 않았나 싶다.</div>
        <span className='inline-block cursor-pointer py-1 px-2 bg-slate-100 rounded text-slate-500 select-none font-medium'>
          {/* 댓글 달기 */}
