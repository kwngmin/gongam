...
export default function NotePost({ note }: Props) {
  ...
  return (
    <article className='py-8 border-t border-gray-300'>
      ...
      <form action='' className='flex bg-slate-100 h-12 p-2 gap-2'>
        <input className='grow bg-red-200 p-2' type='text' />
        <button className='px-2 rounded bg-slate-200'>댓글쓰기</button>
      </form>
    </article>
  );
}
