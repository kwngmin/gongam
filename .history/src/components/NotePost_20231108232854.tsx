  ...
  return (
    <article className='py-8 border-t border-gray-300'>
      ...
      <form action='' className='py-2'>
        <div className='flex p-1 border-0 outline-0 bg-slate-50 rounded-2xl gap-3'>
          <input
            className='grow rounded p-2 focus:border-0 focus:outline-0 bg-transparent'
            type='text'
            placeholder='send message...'
          />
          <button className='px-4 h-12 mx-2 flex justify-center items-center rounded-full text-sm font-medium bg-slate-200'>
            {/* 댓글쓰기 */}Post
