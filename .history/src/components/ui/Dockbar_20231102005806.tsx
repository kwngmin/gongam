...
export default function Dockbar() {
  ...
  return (
    <div className='h-12 flex items-center justify-around w-full max-w-screen-md bg-white fixed bottom-0 left-1/2 -translate-x-1/2'>
      <Link href='/'>
        {pathName === '/' ? (
          <div className='flex items-center justify-center w-12 h-10 rounded-full bg-slate-100'>
      ...
      <Link href='/inbox'>
        {pathName === '/inbox' ? (
          <div className='flex items-center justify-center w-12 h-9 rounded-full bg-slate-100'>
