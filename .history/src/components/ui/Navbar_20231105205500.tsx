  ...
  if (pathName === '/new') {
    return (
      <div className='h-16 flex items-center justify-between relative'>
        ...
        <span className='font-medium absolute top-1/2 left-1/2 -translate-x-1/2'>
          New Note
        </span>
        <div className='bg-slate-900 hover:bg-slate-800 text-white rounded-full px-4 h-8 flex items-center font-medium text-sm select-none'>
          Post
        </div>
      </div>
    );
