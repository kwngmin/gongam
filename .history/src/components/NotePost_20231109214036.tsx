    ...
    <article className='py-8 border-t border-gray-300'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-2 my-2 items-center'>
          ...
          <span
            onClick={() => {}}
            className='w-fit flex items-center gap-1 cursor-pointer py-1 px-2 bg-slate-100 rounded text-slate-400 select-none font-medium'
          >
            <RoundIcon name='forum' filled style='small text-slate-600' />
            전체 보기
          </span>
          {!openInput && (
            <span
